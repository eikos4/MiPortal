...
class PerfilEmpresa(db.Model):
    ...
    logo = db.Column(db.String(255), nullable=True)  # Logo/imagen de empresa
    ...
    def __repr__(self):
        return f"<PerfilEmpresa {self.nombre} (Usuario {self.usuario_id})>"
...
class Evento(db.Model):
    ...
    def __repr__(self):
        return f"<Evento {self.titulo} (Perfil {self.perfil_id})>"
...
class Aviso(db.Model):
    ...
    def __repr__(self):
        return f"<Aviso {self.titulo} (Perfil {self.perfil_id})>"
...
class NoticiaEmpresa(db.Model):
    ...
    def __repr__(self):
        return f"<NoticiaEmpresa {self.titulo} (Perfil {self.perfil_id})>"
...
class Oferta(db.Model):
    ...
    def __repr__(self):
        return f"<Oferta {self.titulo} (Perfil {self.perfil_id})>"
