...
def upgrade():
    ...
    with op.batch_alter_table('perfil_empresa', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            'fk_perfil_empresa_categoria',  # nombre único
            'categoria',                   # tabla referenciada
            ['categoria_id'],              # columna local
            ['id']                         # columna remota
        )
...
def downgrade():
    ...
    with op.batch_alter_table('perfil_empresa', schema=None) as batch_op:
        ...
        # ✅ mismo nombre usado en upgrade
        batch_op.drop_constraint('fk_perfil_empresa_categoria', type_='foreignkey')
