...
def eliminar_aviso(id):
    ...
    # Validar que el aviso pertenece al usuario actual
    if not aviso.empresa or aviso.empresa.usuario_id != current_user.id:
        abort(403)
...
def eliminar_noticia(id):
    ...
    if not noticia.empresa or noticia.empresa.usuario_id != current_user.id:
        abort(403)
...
def eliminar_oferta(id):
    ...
    if not oferta.empresa or oferta.empresa.usuario_id != current_user.id:
        abort(403)
