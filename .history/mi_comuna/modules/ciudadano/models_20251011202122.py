...
class PerfilEmpresa(db.Model):
    ...
    def total_publicaciones(self):
        # Relaciones definidas por backref más abajo
...
class EventoCiudadano(db.Model):
    ...
    perfil = db.relationship(
        "PerfilEmpresa",
        backref=db.backref("eventos", cascade="all, delete-orphan", lazy="dynamic")
    )
...
class AvisoCiudadano(db.Model):
    ...
    perfil = db.relationship(
        "PerfilEmpresa",
        backref=db.backref("avisos", cascade="all, delete-orphan", lazy="dynamic")
    )
...
class NoticiaEmpresa(db.Model):
    ...
    perfil = db.relationship(
        "PerfilEmpresa",
        backref=db.backref("noticias", cascade="all, delete-orphan", lazy="dynamic")
    )
...
class OfertaCiudadano(db.Model):
    ...
    perfil = db.relationship(
        "PerfilEmpresa",
        backref=db.backref("ofertas", cascade="all, delete-orphan", lazy="dynamic")
    )
