...
class PerfilEmpresa(db.Model):
    ...
    # eventos, avisos, noticias, ofertas
...
class Evento(db.Model):
    ...
    perfil = db.relationship("PerfilEmpresa", backref=db.backref("eventos", cascade="all, delete-orphan"))
...
class Aviso(db.Model):
    ...
    perfil_id = db.Column(db.Integer, db.ForeignKey("perfil_empresa.id", ondelete="CASCADE"), nullable=False, index=True)
    perfil = db.relationship("PerfilEmpresa", backref=db.backref("avisos", cascade="all, delete-orphan"))
...
class NoticiaEmpresa(db.Model):
    ...
    perfil_id = db.Column(db.Integer, db.ForeignKey("perfil_empresa.id", ondelete="CASCADE"), nullable=False, index=True)
    perfil = db.relationship("PerfilEmpresa", backref=db.backref("noticias", cascade="all, delete-orphan"))
...
class Oferta(db.Model):
    ...
    perfil_id = db.Column(db.Integer, db.ForeignKey("perfil_empresa.id", ondelete="CASCADE"), nullable=False, index=True)
    perfil = db.relationship("PerfilEmpresa", backref=db.backref("ofertas", cascade="all, delete-orphan"))
