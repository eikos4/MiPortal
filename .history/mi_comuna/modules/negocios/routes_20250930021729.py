...
# 🔹 Importamos PerfilEmpresa (y sus relaciones) para vincular publicaciones
...
def detalle(id):
    ...
    # buscar el perfil empresa del dueño de este negocio (con sus relaciones)
    perfil = (PerfilEmpresa.query
              .options(
              ...
              .filter_by(usuario_id=negocio.usuario_id)
              .first())
    ...
    return render_template("negocios/detalle.html",
                           negocio=negocio,
                           perfil=perfil,
...
def registrar():
    ...
    if not Categoria.query.first():
        iniciales = [
            ...
            "Tiendas de ropa y calzado", "Restaurantes", "Comida rápida",
            ...
            "Gimnasios", "Abogados", "Contadores", "Ingenieros",
...
@negocios_bp.route("/categoria/<int:id>")
def por_categoria(id):
