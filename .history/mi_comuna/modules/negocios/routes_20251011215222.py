...
def detalle(id):
    ...
    # 🔹 Si no existe perfil, feed vacío
    feed = []
    if not perfil:
    ...
    for a in perfil.avisos:
        feed.append({
            ...
            "imagen": a.imagen,
            "extra": {"inicio": getattr(a, "fecha_inicio", None), "fin": getattr(a, "fecha_fin", None)}
        })
    ...
    for e in perfil.eventos:
        feed.append({
            ...
            "imagen": e.imagen,
            "extra": {"fecha": getattr(e, "fecha_inicio", None), "lugar": getattr(e, "lugar", None)}
        })
